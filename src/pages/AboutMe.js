      ...
      >
            <Grid xs={12} md={4}>
                <Paper sx={baseStyle} style={paperStyle}>
                    ...
                    <p style={{textAlign: 'justify', padding: '10px', textIndent: '25px'}}>
                        Meu nome é <b>Mateus Marchão</b>, sou formado em <b>ciência da computação</b> sou programador e pretendo sempre estudar e evoluir nesta área. 
                    </p>
            ...
            <Grid xs={12} md={4}>
                <Paper sx={baseStyle} style={paperStyle}>
                    <h1>Desafios</h1>
                    <p style={{textAlign: 'justify' , padding: '10px' , textIndent: '25px'}}>
                        O maior desafio que encontrei dentro deste trabalho foi de colocar meus conhecimentos em prática
